			  ...
			  <tr>
				<td align="right"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
					  ...
					  <td width="241" align="right"> <img src="images/but_write.gif" width="56" height="21" style="cursor:pointer" onClick="javascript:location.href='writeForm.inc'">
					  																															<!-- 나중에 현재페이지 값(cPage)를 같이 줘야 함 -->	
					  </td>
					</tr>
				  </table></td>
			  </tr>
